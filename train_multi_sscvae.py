...
def validate_epoch(model, dataloader, device):
    ...
    return avg_loss, avg_recon_loss, avg_alignment_loss
...
def main():
    ...
    for epoch in range(1, config['train']['epochs'] + 1):
        ...
        # Validate
        val_loss, val_recon, val_align = validate_epoch(model, val_loader, device)
        ...
        # Save model
        if epoch % config['train']['save_frequency'] == 0:
