...
from utils import GrayDataset, UltrasoundDataset, MiniImagenet, compute_indicators, slice_image, recon_image, get_noise
...
with open(csv_filename, 'w', newline='') as csvfile:
    fieldnames = ['Name', 'PSNR1', 'SSIM1', 'NMI1', 'LPIPS1', 'PSNR2', 'SSIM2', 'NMI2', 'LPIPS2']
